...
**Read this file before writing any code.** If you're an AI coding agent (Antigravity, Claude Code, etc.), this is your entry point — read it in full, then read your agent-specific file (`AGENT_SANJAY.md`, `AGENT_SHASHVAT.md`, or `AGENT_ANISH.md`) before touching anything.
...
| **Shashvat** — Frontend + UI/UX | React app, India map, case list, graph visualization, node interaction, timeline UI, AI assistant UI, evidence/provenance screens, navigation. Owns `frontend/`. |
...
10. Shashvat's agent: frontend only, use documented APIs, never invent endpoints, don't touch backend.
